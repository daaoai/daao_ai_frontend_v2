    ...
    `}
        ...
        <div className="flex flex-col gap-4 flex-grow">
          <div className="flex justify-between items-center">
            ...
            <div className="flex flex-col gap-1">
              ...
              <p className="text-2xl sm:text-3xl font-semibold">$ {abbreviateNumber(tvl)}</p>
            </div>
          </div>
          ...
          <div className="text-left flex flex-col gap-3">
            <div className="flex items-center gap-4">
              <Wallet />
              <p className="text-base sm:text-lg">Total Staked CARTEL : {abbreviateNumber(Number(stakeInfo))} CARTEL</p>
            </div>
            <div className="flex items-center gap-4">
      ...
      <CardFooter className="p-0">
        <Button
          ...
          disabled={!isActive}
        >
          <Link href={`/dapp/farm/mode/${address}`} className="text-lg sm:text-xl font-semibold mr-2">
            View Farm
          </Link>
