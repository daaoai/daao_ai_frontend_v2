...
const DAO_CONTRACT_ADDRESS = "0x402f35e11cC6E89E80EFF4205956716aCd94be04";
...
export const useFetchBalance = (accountAddress: `0x${string}` | undefined) => {
  ...
  useEffect(() => {
    ...
    if (contractData) {
      ...
      const modeBalance = balanceRaw
        ? ethers.utils.formatUnits(balanceRaw, 18)
        : "0";
      ...
      if (tierLimitData) {
        ...
        const maxLimit = maxLimitRaw
          ? Number(maxLimitRaw.toString()) / 10 ** 18
          : 0;
