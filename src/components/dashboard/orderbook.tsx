    ...
    <Card className="w-full max-w-md bg-card text-card-foreground">
      <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
        ...
        <div className="relative h-10 w-10 overflow-hidden rounded-full bg-[#f7931a]">
          <Bitcoin className="h-6 w-6 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white" />
          <div className="absolute bottom-0 right-0 h-4 w-4 bg-background rounded-full border-2 border-background" />
        </div>
      </CardHeader>
