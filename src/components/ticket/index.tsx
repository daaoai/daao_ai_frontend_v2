...
interface TicketPurchaseProps {
  ...
  const TicketPurchase: React.FC<TicketPurchaseProps> = ({ onClose }) => {
  ...
  return (
    <Card className="w-full max-w-lg w-lg">
      {!isSuccess ? (
        <>
          <CardHeader className="flex flex-row justify-between items-center">
            ...
            <Button
              variant="ghost"
              className="text-gray-100 bg-white/20 hover:text-gray-700"
              onClick={onClose}
            >
              ✖ ESC
            </Button>
          ...
          <CardContent>
            <div className="space-y-4">
              ...
              User Balance: {Number(formatUnits((balance ?? 0) as bigint, decimals ?? 18)).toFixed(2)} {symbol}
              </p>
...
<Button
              variant="ghost"
              className="text-gray-500 bg-white/20 hover:text-gray-700"
              onClick={onClose}
            >
              ✖ ESC
            </Button>
