  ...
  return (
    <Card className="box-border w-full max-w-[420px] bg-[#0d0d0d] border-[#383838] text-white flex flex-col">
      <CardContent className="p-6 flex flex-col gap-6 flex-grow">
        ...
        <div className="flex justify-between items-start">
          <div className="flex items-center gap-3">
            <div className="relative w-20 h-[50px] flex-shrink-0">
              <Skeleton className="absolute left-0 top-0 w-[50px] h-[50px] rounded-full" />
              <Skeleton className="absolute left-[30px] top-0 w-[50px] h-[50px] rounded-full" />
            </div>
        ...
        {/* Divider */}
        <Skeleton className="h-[1px] w-full bg-[#383838]" />
      ...
      <CardFooter className="p-0">
        <Skeleton className="w-full h-14 rounded-b-md" />
      </CardFooter>
    </Card>
  );
};
