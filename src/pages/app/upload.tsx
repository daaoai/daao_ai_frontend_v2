  ...
  return (
    <Card className="w-full h-[200px] md:h-[320px] relative mb-20 md:mb-24">
      <div className="w-full h-full bg-[#0d0d0d] flex items-center justify-center">
        ...
        {previewUrl ? (
          <Image
            src={previewUrl || FUND_CARD_PLACEHOLDER_IMAGE}
            alt="Profile"
            layout="fill"
...
export default function UploadPage() {
  ...
  return (
    <PageLayout title="App" description="main-app" app={true}>
      <div className={`relative min-h-screen w-screen overflow-hidden pt-6 px-4 sm:px-8 md:px-16 lg:px-20  ${workSans.className} text-left`}>
        <Form {...form}>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Textarea placeholder="Tell us about your project" className="resize-none h-[200px]" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
