...
const Contribute: React.FC = () => {
  const [amount, setAmount] = useState<string>(""); // Amount in ETH
  ...
  const handleContribute = async () => {
    try {
      ...
      console.log("daoscontracts is ",daosContract);
  ...
  return (
    <div style={{ maxWidth: "600px", margin: "0 auto", padding: "20px" }}>
      ...
      <p>Enter the amount of ETH you want to contribute to the pool and click "Contribute".</p>
